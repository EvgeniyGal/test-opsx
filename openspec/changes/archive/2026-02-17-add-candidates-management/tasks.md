...
- [x] 17.1 Test all CRUD operations (create, read, update, delete candidates)
- [x] 17.2 Test status transitions and validation (forward-only, prevent backward)
- [x] 17.3 Test CV upload with valid files (PDF, DOC, DOCX)
- [x] 17.4 Test CV upload with invalid files (wrong type, oversized)
- [x] 17.5 Test CV download with signed URLs
- [x] 17.6 Test Kanban drag-and-drop status updates
- [x] 17.7 Test RBAC enforcement (Owner, Manager, Admin permissions)
- [x] 17.8 Test responsive design (mobile cards, desktop table)
- [x] 17.9 Test candidate assignment functionality
- [x] 17.10 Test notes and comments creation and display
- [x] 17.11 Test status history tracking
- [x] 17.12 Performance testing with large datasets (if applicable)
- [x] 17.13 Accessibility testing (keyboard navigation, screen readers)
